...
gate_1 setpos [ getPos gate_1 select 0, getPos gate_1 select 1, -2.34];
gate_2 setpos [ getPos gate_2 select 0, getPos gate_2 select 1, -2.34];
gate_3 setpos [ getPos gate_3 select 0, getPos gate_3 select 1, -2.34];
gate_4 setpos [ getPos gate_4 select 0, getPos gate_4 select 1, -2.34];
gate_5 setpos [ getPos gate_5 select 0, getPos gate_5 select 1, -2.34];
